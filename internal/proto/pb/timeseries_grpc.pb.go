...
const (
	TimeSeriesService_QueryData_FullMethodName = "/timeseries.TimeSeriesService/QueryData"
)
...
func (c *timeSeriesServiceClient) QueryData(ctx context.Context, in *QueryRequest, opts ...grpc.CallOption) (*QueryResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(QueryResponse)
	err := c.cc.Invoke(ctx, TimeSeriesService_QueryData_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTimeSeriesServiceServer) QueryData(context.Context, *QueryRequest) (*QueryResponse, error) {
...
func _TimeSeriesService_QueryData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TimeSeriesServiceServer).QueryData(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TimeSeriesService_QueryData_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TimeSeriesServiceServer).QueryData(ctx, req.(*QueryRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _TimeSeriesService_QueryData_Handler,
		},
	},
